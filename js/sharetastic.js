                ...
                var defaults = {
                    ...
                    services: {
                        ...
                        pinterest: {
                            order: 3,
                            name: 'Pinterest',
                            href: 'https://pinterest.com/pin/create/link/?' + this.generateUrl('url=') + this.generateTitle('&description=') + this.generateImage('&media='),
                            icon: {
                                width: 32,
                                height: 32,
                        ...
                        tumblr: {
                            order: 7,
                            name: 'Tumblr',
                            href: 'https://www.tumblr.com/share/link?' + this.generateUrl('&url=') + this.generateTitle('&name=') + this.generateDescription('&description='),
                            icon: {
                                width: 32,
                                height: 32,
